...
**Objective.** Implement and evaluate a *lottery scheduler* — a probabilistic CPU scheduler that allocates CPU time in proportion to the number of tickets each process holds.
